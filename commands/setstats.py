class CmdSetStats(default_cmds.MuxCommand):
    ...
    def func(self):
        caller = self.caller
        rolls = 25
        msg1 = ("Runaria uses a method of rolling the dice to create player attributes. "
                ...
                "follows: strength dexterity constitution intelligence wisdom charisma\n\n"
                "You will only be able to roll 25 times, so when you see a decent roll, "
